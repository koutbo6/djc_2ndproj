"""
Django settings for kbreviews project.
...
SECRET_KEY = 'jbbt=&o=v)mb!+^_6waci4aqi_p4m&)e!_8s%^l2hyp@w=urnp'
...
ROOT_URLCONF = 'kbreviews.urls'

WSGI_APPLICATION = 'kbreviews.wsgi.application'
